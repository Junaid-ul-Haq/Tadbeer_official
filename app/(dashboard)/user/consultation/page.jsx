  ...
  return (
    <div className="p-6 font-[var(--font-family)] text-[var(--text-color)]">
      <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
        <div>
          <h1 className="text-3xl font-bold mb-2">Book Career Counseling</h1>
          <p className="text-gray-400 text-sm">
            View all your career counseling requests in the{" "}
      ...
      <div className="bg-[#1A1A1A]/60 rounded-xl border border-white/10 p-8 text-center">
        <p className="text-gray-400 text-lg">
          All your career counseling requests can be viewed in the Overview page.
        </p>
      </div>
    </div>
  );
